...
export const CategoriesChart: FunctionComponent = () => {
  ...
  const averagePagesExplanation =
    "Widows' pension applications often grew to many pages because they required substantial proof of marriage and eligibility, and this proof was not always easy to obtain. Applicants frequently included marriage certificates, family Bible records, witness affidavits, and other supporting documents.";
